...
\ThesisSetKeywords{pairwise preference, IR} % only for PDF meta attributes
...
\include{front_page}
% starting chapter abstract on the right side
...
% starting chapter1 on the right side
\newpage\null\thispagestyle{empty}\newpage
\end{frontmatter}
\include{chapter1}

% starting chapter2 on the right side
\newpage\null\thispagestyle{empty}\newpage
\include{chapter2}

% starting chapter3 on the right side
\newpage\null\thispagestyle{empty}\newpage
\include{chapter3}

% starting chapter4 on the right side
\newpage\null\thispagestyle{empty}\newpage
\include{chapter4}

\include{chapter5}

% starting chapter appendixA on the right side
\newpage\null\thispagestyle{empty}\newpage
\include{appendixA}

% Bibliography
\bibliographystyle{plain} % requires package natbib. An alternative is apalike
