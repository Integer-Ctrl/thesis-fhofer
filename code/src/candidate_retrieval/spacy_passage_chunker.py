...
nlp.max_length = 2200000  # for documents that are longer than the spacy character limit
...
class SpacyPassageChunker(AbstractPassageChunker):
    ...
    def process_batch(self, document_batch) -> None:
        ...
        for index, document in enumerate(processed_document_texts):  # Removed tqdm
