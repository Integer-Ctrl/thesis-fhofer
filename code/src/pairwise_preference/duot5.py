# https://github.com/seanmacavaney/autoqrels.git
# copied from: https://github.com/seanmacavaney/autoqrels/blob/main/autoqrels/oneshot/duot5.py
...
class DuoT5(OneShotLabeler):
    def __init__(self, dataset, model_name='castorini/duot5-3b-msmarco', tokeniser_name='t5-3b', device=None,
                 batch_size=8, verbose=False, query_field=None, doc_field=None, cache_path=None):
