...
def build_paths(config):
    ...
    paths = {
        ...
        "RANK_CORRELATION_SCORE_AQ_PATH": os.path.join(
            SOURCE_PATH, config["RANK_CORRELATION_SCORE_AQ_PATH"]),
        "RANK_CORRELATION_SCORE_PQ_PATH": os.path.join(
            SOURCE_PATH, config["RANK_CORRELATION_SCORE_PQ_PATH"]),
        ...
        "DUOT5_QID_DOC_DOC_SYSTEM_SCORES_PATH": os.path.join(TARGET_PATH, config["DUOT5_QID_DOC_DOC_SYSTEM_SCORES_PATH"]),
    }
    return paths
