...
def build_paths(config):
    ...
    OLD_PATH = os.path.join(DATA_PATH, config["DOCUMENT_DATASET_SOURCE_NAME"])
    NEW_PATH = os.path.join(DATA_PATH, config["DOCUMENT_DATASET_TARGET_NAME"])
    ...
    paths = {
        ...
        "RANK_CORRELATION_SCORE_PATH": os.path.join(
            OLD_PATH, config["RANK_CORRELATION_SCORE_PATH"]),
        "RANK_CORRELATION_SCORE_AQ_PATH": os.path.join(
            OLD_PATH, config["RANK_CORRELATION_SCORE_AQ_PATH"]),
        "RANK_CORRELATION_SCORE_PQ_PATH": os.path.join(
            OLD_PATH, config["RANK_CORRELATION_SCORE_PQ_PATH"]),
        ...
        "DOCUMENT_DATASET_TARGET_INDEX_PATH": os.path.join(NEW_PATH, config["DOCUMENT_DATASET_TARGET_INDEX_PATH"]),
        "PASSAGE_DATASET_TARGET_PATH": os.path.join(NEW_PATH, config["PASSAGE_DATASET_TARGET_PATH"]),
        "PASSAGE_DATASET_TARGET_INDEX_PATH": os.path.join(NEW_PATH, config["PASSAGE_DATASET_TARGET_INDEX_PATH"]),
