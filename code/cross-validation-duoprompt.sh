...
#SBATCH --output=logs/cross_validation/duoprompt_%j.out     # Standard output log
#SBATCH --error=logs/cross_validation/duoprompt_%j.err      # Standard error log
...
python3 -u src/pairwise_preference/evaluation/cross_validation.py
echo "Cross-validation (duoprompt labels) completed."