...
#SBATCH --output=logs/cross_validation/monoprompt_%j.out     # Standard output log
#SBATCH --error=logs/cross_validation/monoprompt_%j.err      # Standard error log
...
python3 -u src/pointwise_preference/evaluation/cross_validation.py
echo "Cross-validation (monoprompt labels) completed."